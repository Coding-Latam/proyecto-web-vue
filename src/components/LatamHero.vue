...
<template>
  <section class="flex flex-col gap-20 py-14 px-0">
    ...
    <span class="self-center text-paragraph-color">Trusted by over 2K+ clients across the world</span>
    <div class="container flex overflow-x-hidden mx-auto max-w-7xl">
      <LatamMarquee />
      <LatamMarquee />
    </div>
  </section>
